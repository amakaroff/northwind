...
@WebService(endpointInterface = "org.northwind.application.ws.api.CategoryWebService", portName = "CategoryWebServicePort", serviceName = "CategoryWebService", targetNamespace = "http://ws.northwind.org/")
