...
privileged aspect ShippersItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView ShippersItemThymeleafController.update(@Valid @ModelAttribute Shipper shipper, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
