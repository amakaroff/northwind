...
privileged aspect SuppliersItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView SuppliersItemThymeleafController.update(@Valid @ModelAttribute Supplier supplier, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
