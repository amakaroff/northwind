...
public class SuppliersItemThymeleafController {
    ...
    public ModelAndView update(@Valid @ModelAttribute Supplier supplier, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
