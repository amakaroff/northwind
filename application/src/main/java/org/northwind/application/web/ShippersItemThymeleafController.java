...
public class ShippersItemThymeleafController {
    ...
    public ModelAndView update(@Valid @ModelAttribute Shipper shipper, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
