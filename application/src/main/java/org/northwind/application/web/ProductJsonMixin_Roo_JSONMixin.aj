...
privileged aspect ProductJsonMixin_Roo_JSONMixin {
    ...
    private CustomerOrder ProductJsonMixin.category;
     ...
     */
    public CustomerOrder ProductJsonMixin.getCategory() {
        return category;
    }
     ...
     * @param category
     */
    public void ProductJsonMixin.setCategory(CustomerOrder category) {
