...
public class StoresItemThymeleafController {
    ...
    public ModelAndView update(@Valid @ModelAttribute Store store, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
