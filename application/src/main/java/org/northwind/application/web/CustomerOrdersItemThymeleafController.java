...
public class CustomerOrdersItemThymeleafController {
    ...
    public ModelAndView update(@Valid @ModelAttribute CustomerOrder customerOrder, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
