...
privileged aspect CustomerOrdersCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void CustomerOrdersCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_customerorder_name", null, "Name", locale), "name", String.class.getName(), 100);
        }
        else if (columnName.equals("description")) {
            builder.addColumn(getMessageSource().getMessage("label_customerorder_description", null, "Description", locale), "description", String.class.getName(), 100);
        }
