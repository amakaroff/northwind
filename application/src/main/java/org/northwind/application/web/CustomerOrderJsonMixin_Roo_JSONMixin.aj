...
privileged aspect CustomerOrderJsonMixin_Roo_JSONMixin {
     ...
     */
    @JsonIgnore
    private Set<Product> CustomerOrderJsonMixin.products;
     ...
     * @return Set
     */
    public Set<Product> CustomerOrderJsonMixin.getProducts() {
        return products;
    }
     ...
     * @param products
     */
    public void CustomerOrderJsonMixin.setProducts(Set<Product> products) {
