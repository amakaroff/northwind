...
privileged aspect ProductServiceImpl_Roo_Service_Impl {
     ...
     * @return Page
     */
    public Page<Product> ProductServiceImpl.findByCategory(CustomerOrder category, GlobalSearch globalSearch, Pageable pageable) {
     ...
     * @return Long
     */
    public long ProductServiceImpl.countByCategory(CustomerOrder category) {
