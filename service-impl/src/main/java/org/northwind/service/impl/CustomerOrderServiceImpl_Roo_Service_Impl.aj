...
privileged aspect CustomerOrderServiceImpl_Roo_Service_Impl {
     ...
     * 
     */
    private ProductService CustomerOrderServiceImpl.productService;
     ...
     */
    @Autowired
    public CustomerOrderServiceImpl.new(CustomerOrderRepository customerOrderRepository, @Lazy OrderDetailService orderDetailService, @Lazy ProductService productService) {
     ...
     */
    public ProductService CustomerOrderServiceImpl.getProductService() {
        return productService;
    }
     ...
     * @param productService
     */
    public void CustomerOrderServiceImpl.setProductService(ProductService productService) {
     ...
     */
    @Transactional
    public CustomerOrder CustomerOrderServiceImpl.addToProducts(CustomerOrder customerOrder, Iterable<Long> productsToAdd) {
        List<Product> products = getProductService().findAll(productsToAdd);
        customerOrder.addToProducts(products);
        return getCustomerOrderRepository().save(customerOrder);
    }
     ...
     */
    @Transactional
    public CustomerOrder CustomerOrderServiceImpl.removeFromProducts(CustomerOrder customerOrder, Iterable<Long> productsToRemove) {
        List<Product> products = getProductService().findAll(productsToRemove);
        customerOrder.removeFromProducts(products);
        return getCustomerOrderRepository().save(customerOrder);
    }
     ...
     */
    @Transactional
    public CustomerOrder CustomerOrderServiceImpl.setProducts(CustomerOrder customerOrder, Iterable<Long> products) {
        List<Product> items = getProductService().findAll(products);
        Set<Product> currents = customerOrder.getProducts();
        ...
        customerOrder.removeFromProducts(toRemove);
        customerOrder.addToProducts(items);
        // Force the version update of the parent side to know that the parent has changed
        // because it has new books assigned
        customerOrder.setVersion(customerOrder.getVersion() + 1);
        return getCustomerOrderRepository().save(customerOrder);
    ...
    public void CustomerOrderServiceImpl.delete(CustomerOrder customerOrder) {
        ...
        for (Product item : customerOrder.getProducts()) {
