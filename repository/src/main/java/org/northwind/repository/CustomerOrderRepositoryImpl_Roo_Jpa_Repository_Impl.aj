...
privileged aspect CustomerOrderRepositoryImpl_Roo_Jpa_Repository_Impl {
     ...
     * 
     */
    public static final String CustomerOrderRepositoryImpl.NAME = "name";
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    public static final String CustomerOrderRepositoryImpl.DESCRIPTION = "description";
    ...
    public Page<CustomerOrder> CustomerOrderRepositoryImpl.findAll(GlobalSearch globalSearch, Pageable pageable) {
        ...
        Path<?>[] paths = new Path<?>[] {customerOrder.name,customerOrder.description,customerOrder.city,customerOrder.country,customerOrder.customer,customerOrder.orderDate,customerOrder.requiredDate,customerOrder.shippedDate,customerOrder.freight,customerOrder.shipName,customerOrder.shipAddress,customerOrder.shipPostalCode,customerOrder.status,customerOrder.shipPhone,customerOrder.invoiceDate,customerOrder.closeDate,customerOrder.region,customerOrder.shipper};        
        applyGlobalSearch(globalSearch, query, paths);
        
        AttributeMappingBuilder mapping = buildMapper()
			.map(NAME, customerOrder.name)
			.map(DESCRIPTION, customerOrder.description)
