...
privileged aspect SupplierRepositoryImpl_Roo_Jpa_Repository_Impl {
    ...
    public Page<Supplier> SupplierRepositoryImpl.findAll(GlobalSearch globalSearch, Pageable pageable) {
        ...
        Path<?>[] paths = new Path<?>[] {supplier.city,supplier.region,supplier.companyName,supplier.contactName,supplier.contactTitle,supplier.address,supplier.postalCode,supplier.phone,supplier.fax,supplier.web};        
