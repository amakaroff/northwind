...
privileged aspect ProductRepositoryImpl_Roo_Jpa_Repository_Impl {
    ...
    public Page<Product> ProductRepositoryImpl.findAll(GlobalSearch globalSearch, Pageable pageable) {
        ...
        Path<?>[] paths = new Path<?>[] {product.category,product.name,product.code,product.quantityPerUnit,product.unitCost,product.unitPrice,product.reorderLevel,product.discontinued,product.supplier};        
     ...
     * @return Page
     */
    public Page<Product> ProductRepositoryImpl.findByCategory(CustomerOrder category, GlobalSearch globalSearch, Pageable pageable) {
